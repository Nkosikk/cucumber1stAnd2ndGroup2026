...
public class stepsDef {
    ...
    public void i_am_on_the_login_page() {
        ...
        //driver.get("https://ndosisimplifiedautomation.vercel.app/#practice");  //doesn't require the 1st login Btn
    ...
    public void i_enter_email(String email) {
        ...
        //driver.findElement(By.xpath("By.xpath(\"//button[contains(.,'Login')]\")")).click();
